...
document.getElementById("generateGraphBtn").addEventListener("click", function () {
    // Clear all previous data from global variables
    currentPrice = NaN; expectedPrice = NaN; maxDollarInvest = NaN; maxStockInvest = NaN; comissionCharge = NaN; stockPriceIncrements = NaN; numberOfStocksIncrement = NaN;
...
function generateAllMatrix() {
    stockPriceList.forEach(function (stockPrice, index) {
        ...
        numberOfStocksList.forEach(function (numOfStocks, index) {
            var profit = ((numOfStocks * stockPrice) - totalInvestmentList[index]) - comissionCharge;
